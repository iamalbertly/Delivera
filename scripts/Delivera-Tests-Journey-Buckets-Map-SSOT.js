...
export const specMetadata = {
  ...
  'tests/Delivera-Governance-Trust-Recovery-MasterPlan-Realtime-Logcat-Validation-Tests.spec.js': {
    ...
    layer: 'page-ux',
    page: '/governance,/current-sprint,/actions,/settings,/api/governance/active-loop.json,/api/governance/registry,/api/governance/actions.json',
    priority: 0,
  },
  ...
  'tests/Delivera-Customer-Simplicity-Trust-DirectValue-Validation-Tests.spec.js': {
    journey: 'journey.ux-core',
    layer: 'cross-surface-ux',
    page: '/governance,/home,/report',
  },
  'tests/Delivera-Customer-Growth-Round3-DirectValue-Validation-Tests.spec.js': {
    journey: 'journey.ux-core',
    layer: 'cross-surface-ux',
  ...
  'tests/Delivera-Governance-UX-MasterPlan-Round4-Realtime-Logcat-Validation-Tests.spec.js': {
    journey: 'journey.governance-ux-masterplan-round4',
    layer: 'cross-surface-ux',
    page: '/governance,/current-sprint,/actions,/settings',
    priority: 'P0',
  },
...
export const journeyBuckets = {
  ...
  'journey.governance-ux-masterplan-round4': {
    id: 'journey.governance-ux-masterplan-round4',
    label: 'Governance UX Round4 – risk truth, focus strip, friction cuts',
    specs: Object.keys(specMetadata).filter(
      (spec) => specMetadata[spec].journey === 'journey.governance-ux-masterplan-round4',
    ),
  },
