...
export function buildHumanImpact({ valueEvidence = {}, story = {} } = {}) {
  ...
  const statements = {
    customer: 'Customers or frontline teams remain blocked from completing the intended journey.',
    efficiency: 'The team continues carrying avoidable manual effort while this work is blocked.',
    regulatory: 'The approved compliance outcome remains unverified while this work is blocked.',
    growth: 'The approved growth outcome remains delayed while this work is blocked.',
