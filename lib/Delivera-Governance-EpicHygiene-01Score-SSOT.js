 ...
 */
import { matchesAnyBaselineTitle } from '../public/Delivera-Governance-TitleSimilarity-01SSOT.js';
...
export function detectAdHocEpics(brief = {}, boardPayloads = []) {
  ...
  for (const e of epicKeys) {
    ...
    if (baselineItems.length && matchesAnyBaselineTitle(e.summary, baselineItems)) continue;
