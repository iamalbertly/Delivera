...
export const appEnvConfig = {
  ...
  port: Number(process.env.PORT) || readDevPortFile() || 3000,
...
export const aiProviderEnvConfig = {
  ...
  openrouterModelVision: trimEnvValue(process.env.OPENROUTER_MODEL_VISION) || trimEnvValue(process.env.OPENROUTER_MODEL_IMAGE),
