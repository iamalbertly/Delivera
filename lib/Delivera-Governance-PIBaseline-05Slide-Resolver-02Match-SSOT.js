...
/**
 * Playbook canonical title wins over AI drift (e.g. DMS – EVOD → DMS – NBA – EVOD Upgrade).
 */
export function resolveSuggestedEpicTitle({
  ...
  return buildCanonicalEpicTitle({
    quarter: qKey,
    program: squad,
...
export function resolveSlideCommitments({
  ...
  for (const row of extracted) {
    ...
    const shouldAutoLink = !match && dupRisk?.issueKey && (
