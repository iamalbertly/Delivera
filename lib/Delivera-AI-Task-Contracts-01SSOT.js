...
export const AI_TASK_TYPES = Object.freeze({
  ...
  PI_SLIDE_VISION: 'pi-slide-vision',
...
export const MODEL_POLICY = Object.freeze({
  ...
  [AI_TASK_TYPES.PI_SLIDE_VISION]: 'vision, structured slide extraction',
...
function piSlideVisionFallback() {
  return {
    squad: '',
    quarter: '',
    commitments: [],
...
export const AI_TASK_CONTRACTS = Object.freeze({
  ...
  [AI_TASK_TYPES.PI_SLIDE_VISION]: {
    taskType: AI_TASK_TYPES.PI_SLIDE_VISION,
    inputContract: 'slide image + quarter + projects',
    allowedFields: ['quarter', 'projects', 'userText', 'systemPrompt', 'imageBase64', 'mimeType'],
    forbiddenFields: FORBIDDEN_FACT_FIELDS,
    outputSchema: {
      squad: 'string',
      quarter: 'string',
    ...
    maxCostTier: 'medium',
    requiresHumanApproval: true,
    fallbackFn: piSlideVisionFallback,
  },
