...
function buildDecisionOptions(recommendation = {}) {
  ...
  const defaultId = preferred === PORTFOLIO_RECOMMENDATIONS.MOVE_CAPACITY
    ? 'move-capacity'
    : preferred === PORTFOLIO_RECOMMENDATIONS.CONTINUE_SCALE
      ? 'keep-funding'
      : 'review-investment';
  return [
    { id: 'keep-funding', label: 'Keep funding', hint: 'Continue as planned', selected: defaultId === 'keep-funding' },
    { id: 'review-investment', label: 'Review investment', hint: 'Fix issues and revalidate outcomes', selected: defaultId === 'review-investment' },
    { id: 'move-capacity', label: 'Move capacity', hint: 'Reallocate to higher impact', selected: defaultId === 'move-capacity' },
  ];
}
