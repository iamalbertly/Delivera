...
import { appEnvConfig, jiraEnvConfig, legacySessionEnvConfig } from './Jira-Reporting-App-Config-Env-Services-Core-SSOT.js';
  ...
  if (enableBackgroundWorkers) {
    ...
    if (hasHost && hasEmail && hasToken) {
      logger.info('Jira credentials loaded', {
        ...
        emailPrefix: `${process.env.JIRA_EMAIL.substring(0, 3)}***`,
      });
    } else {
