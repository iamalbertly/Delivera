...
function realityLabel(state = '', { hasJiraMatch = false, issueKey = '' } = {}) {
...
function rowFromBaselineItem(item = {}, { evidencePack = {}, brief = {}, anchorKey = '' } = {}) {
  ...
  return {
    ...
    governanceState,
    reality: realityLabel(governanceState, { hasJiraMatch: issueKey && item.verdict !== BASELINE_VERDICTS.REMOVED, issueKey }),
