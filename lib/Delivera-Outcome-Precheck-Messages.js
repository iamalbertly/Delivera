...
export const OUTCOME_PRECHECK_KEYS = Object.freeze({
  ...
  TRUNCATED: 'truncated',
  RICH_TEAMS_FORMAT: 'rich_teams_format',
});
...
const MESSAGES = {
  ...
  [OUTCOME_PRECHECK_KEYS.RICH_TEAMS_FORMAT]: 'Chat format detected — story points, issue types, and assignees extracted automatically.',
};

// "fix" removed — too broad as a standalone word (dev tasks like "Validate and Fix X" are planned work).
// Use "hotfix" for release patches; "bug" for defect tracking; standalone "fix" is an action verb.
const SUPPORT_WORDS = /\b(support|defect|downstream|maintenance|adhoc|hotfix|bug|investigation)\b/i;
