...
function squadMeaning({ attentionState, unsupportedCount = 0, aligned = '', openCases = 0 } = {}) {
  if (attentionState === ATTENTION_STATES.CANNOT_VERIFY) return 'Alignment cannot be verified';
