...
export const COPY = {
  ...
  cadenceActiveNoMovement: 'Sprint stalled · 0% movement',
  cadenceActiveStalled: 'Sprint stalled',
  ...
  portfolioLegend: 'Governance brief compares PI baseline promises with Jira evidence and prepared actions.',
  governancePrimaryAction: 'Review and record governance decision',
  governanceEvidenceAction: 'Inspect unsupported promises',
  governanceShareSponsorBrief: 'Share sponsor brief',
  governanceRecordScopeDecision: 'Record scope decision',
  governanceConfirmExtracted: 'Confirm extracted commitment',
  governanceLinkJiraWork: 'Link promise to Jira work',
  governanceAssignOwner: 'Assign commitment owner',
  ...
  aiSlideChecking: 'Checking AI readiness…',
  aiSlideReadyShort: 'Slides ready',
  aiSlideTemplatesOnly: 'Templates only — slides need AI',
  aiSlideReadingSub: 'Usually 10–30 seconds',
  aiBrowserOverrideFailed: 'Browser override failed — using server AI',
  aiCapabilityEnvNote: 'Server AI is configured in .env — browser override is optional.',
  ...
  baselineSlideMatching: 'Reading slide and matching Jira board epics…',
  ...
  baselineSlideMatching: 'Matching Jira epics…',
  baselineSlideReadFailed: 'Could not read commitments from slide — check AI in Settings or retry.',
  baselineSlideFailNoKey: 'No AI key set — add one in Settings to read slides.',
  baselineSlideFailNoKeyCta: 'Add AI key',
  baselineSlideFailTimeout: 'Slide read timed out — try a smaller image or retry.',
  baselineSlideFailNoText: 'No readable text found in the slide — upload a clearer export.',
  baselineSlideFailQuota: 'AI quota exceeded — check your provider usage or retry later.',
  baselineSlideFailGeneric: 'Slide read failed — retry or add an AI key in Settings.',
  baselineSlideFailCtaSettings: 'Open AI settings',
  baselineSlideFailCtaRetry: 'Retry upload',
  baselineSlideProgressRead: 'Reading image',
  baselineSlideProgressExtract: 'Extracting epics',
  baselineSlideProgressMatch: 'Matching board',
  epicFormatSettingsTitle: 'Epic naming format',
  epicFormatSettingsHint: 'All squads use this pattern when creating epics from PI slides or Alignment Studio.',
  epicFormatSettingsSave: 'Save epic format',
  epicFormatSettingsReadOnly: 'Only org administrators can edit epic format.',
  epicFormatSettingsApplies: 'Applies to all squads on the next epic create.',
  baselineSlideMethod: 'Read slide',
  baselineSlideMatched: 'In Jira — confirm for on-track tracking',
  baselineSlideMissing: 'Not linked yet — refresh match or use existing epic',
  baselineSlideSoftMatch: 'Likely match in Jira — confirm link',
  ...
  baselineSlideCachedHint: 'Showing cached slide read — refresh to re-match Jira',
  baselineSlideCachedRefresh: 'Refresh match',
  baselineSlideDupReview: 'Possible existing epics — review before creating:',
  baselineSlidePoolEmpty: 'No Jira epics loaded for matching — open Governance brief for this squad, then refresh match.',
