...
export const COPY = {
  ...
  close: 'Close',
  baselineTitle: 'Set PI baseline',
  baselineStep1: 'Add committed PI issues in Jira',
  baselineStep2: 'Refresh the brief',
  baselineStep3: 'Confirm baseline here',
  baselineEmptyHint: 'No PI candidates yet — add issues in Jira, then refresh.',
  baselineConfirmTitle: 'Confirm PI baseline',
  baselineConfirmHint: 'Uncheck items that are not PI commitments. Method:',
  baselineConfirmBtn: 'Confirm baseline',
