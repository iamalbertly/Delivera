...
export const COPY = {
  ...
  proofIncomplete: 'Proof incomplete',
  alignmentChip: 'Alignment',
  alignmentChipOk: 'Alignment OK',
  alignmentChipHint: 'Epic naming vs PI baseline and ad-hoc scope',
  roleVerbSm: 'Unblock sprint work',
  roleVerbPo: 'Confirm evidence',
  roleVerbRte: 'Escalate cross-squad ripple',
  roleVerbPmo: 'Review portfolio risk',
  nudgeCommandment: 'Sprint timebox ended — close or carry work via Actions.',
  cacheRefreshTitle: 'Refreshing verified proof…',
